...
/*
Cx51 Interrupt Functions

Basic
======
Interrupt	Desc				Address
...
8051 vendor creat more interrupts. Cx51 supports 32. TW8836 using 0 to 20.




The interrupt polling sequence (from highest to lowest) is:-
INT0
TF0
INT1
TF1
...
The interrupt attribute takes as an argument an integer constant in the 0 to 31 value range.
The using function attribute is used to select a register bank different from that of the non-interrupt program code.
